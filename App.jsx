          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mt-12">
              ...
              <p className="text-gray-600 mt-4">
                {language === 'es'
                  ? 'Todas las fotos y videos también están disponibles en nuestro Google Drive'
                  : 'Argazki eta bideo guztiak Google Drive gurean ere eskuragarri daude'}
              </p>
              <a
                href={clubInfo.googleDrive}
                target="_blank"
              ...
              >
                {language === 'es' ? 'Acceder a Google Drive' : 'Sartu Google Drive-ra'}
              </a>
            </div>
          </div>
        </section>
